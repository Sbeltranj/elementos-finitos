...
# Para limpiar variables en Juno IDE, escribir en consola Ctrl + d
# En consola de Julia escribir workspace()
#clearconsole()
#%%
...
theta = [ atand(2,4)  atand(4,3)  atand(-6,2) ]; # ángulo inclinacion (grados)
...
T   = Array{Array{Float64}}(undef, nb,1)        # matriz de transformacion de coordenadas
